...
```{r include=F, error=T}
plotly::api_create(plotly::ggplotly(p), filename = "geom_polygon_1")
```
...
```{r include=F, error=T}
plotly::api_create(plotly::ggplotly(p), filename = "geom_polygon_2")
```
...
```{r include=F, error=T}
plotly::api_create(plotly::ggplotly(p), filename = "geom_polygon_3")
```